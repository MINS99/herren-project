...
public class ShopController {
    ...
    @PutMapping("/{shopId}/employee/{employeeId}")
    public ResponseEntity<Void> updateEmployeeToShop(@PathVariable("shopId") Long shopId, @PathVariable("employeeId") Long employeeId) {
        shopService.updateEmployeeToShop(shopId, employeeId);
